...
export default function Work() {
    return (
        <div className='bg-white min-h-screen'>
            <Navbar />
            <div className='w-full mx-auto h-full text-black'>
                <div id="topSection" className='w-full flex flex-col bg-yellow mx-auto justify-center p-6'>
                    <div className='w-full h-full text-center px-2 mx-auto gap-4 md:gap-8 flex md:flex-row flex-col'>
                        <div className='w-full md:w-1/3'>
                            <h1 className='text-2xl underline underline-offset-4'>Mission</h1>
                        ...
                        <div className='w-full md:w-1/3'>
                            <h1 className='text-2xl underline underline-offset-4 '>Vision</h1>
                        ...
                        <div className='w-full md:w-1/3'>
                            <h1 className='text-2xl underline underline-offset-4 '>Values</h1>
                ...
                <div id="bottomSection" className="w-3/4 mx-auto min-h-screen grid grid-rows-6 grid-cols-1 md:grid-rows-2 md:grid-cols-3 gap-6 my-4 px-6 md:px-12">
                    ...
                    <div className="order-2 text-center md:text-left row-span-2 col-span-1 md:row-span-1 md:col-span-2 relative block">
                        <h1 className='text-2xl underline underline-offset-4 mb-2'>Movement Programs</h1>
                    ...
                    <div className="order-4 text-center md:text-left md:order-3 row-span-2 col-span-1 md:row-span-1 md:col-span-2 relative block">
                        <h1 className='text-2xl underline underline-offset-4 mb-2'>Creative Art Programs</h1>
                    ...
                    <div className="order-6 text-center md:text-left row-span-2 col-span-1 md:row-span-1 md:col-span-2 relative block">
                        <h1 className='text-2xl underline underline-offset-4 mb-2'>Mental Health Education</h1>
