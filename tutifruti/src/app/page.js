  ...
  return (
    <div className="bg-white">
      ...
      <div className="min-h-screen bg-white flex flex-col">
        ...
        <p className='mx-auto mt-4 mb-2 text-xl w-3/4 text-center text-black p-2'>Welcome to Tutifruti, where we blend the vibrant worlds of skateboarding, rollerskating, and creative arts to champion the cause of mental health education and advocacy. We host a spectrum of experiences, from dynamic community events and creative art workshops to skate clinics and private lessons, igniting dialogues and fostering support networks. Tutifruti stands firm in embracing and empowering diverse demographics, especially women, girls, BIPOC, and LGBTQ+ individuals. Join us on this transformative journey, where every contribution fuels a brighter, more mentally resilient world!</p>
