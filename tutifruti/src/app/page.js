    ...
    <div className="bg-white">
      ...
      <div className="min-h-screen bg-white flex flex-col">
        <div className='w-full flex flex-col bg-lotStretch bg-no-repeat bg-cover bg-center mx-auto justify-between p-12 lg:p-16'>
          <h1 className="text-3xl rounded-md my-10 mx-auto w-3/4 text-center text-white font-tutifruti">tutifruti promotes mental health and physical wellness in disenfranchised communities through skate and art.</h1>
