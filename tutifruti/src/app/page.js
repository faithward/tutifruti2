    ...
    <div className="bg-white">
      ...
      <div className="min-h-screen bg-white flex flex-col">
        <div className='w-full flex flex-col bg-haulover bg-no-repeat bg-cover bg-center mx-auto justify-center p-6'>
          ...
          <br></br>
          <br></br>
          <Link className="mx-auto mt-6" target="_blank" href="https://linktr.ee/tutifruti.sk8?lt_utm_source=lt_share_link#302007025"><Image alt="support us" src="supportusbutton.svg" width={200} height={100} /></Link>
        </div>
