...
export default function About() {
    return (
        <div class="bg-white h-full">
            <Navbar />
            <h1 class="text-center text-4xl font-mono">Meet Our Team</h1>
                ...
                <div class="flex flex-col gap-4 p-6">
                    ...
                    <div class="flex sm:flex-row flex-col gap-4">
                        <div class="bg-tan border-2 border-solid border-darkblue rounded-lg">
                            <h1 class="text-center text-xl font-mono">Isa</h1>
                            <h4 class="text-center pb-1 font-mono">President</h4>
                        ...
                        <div class="bg-tan border-2 border-solid border-darkblue rounded-lg">
                            <h1 class="text-center text-xl font-mono">Romina</h1>
                            <h4 class="text-center pb-1 font-mono">Vice President</h4>
